...
* [页面细节](#page-details)
    ...
    * [页脚](#footer)
    * [第三方统计](#statistical-analysis)
* [使用方法](#usage)
    * [1. 安装 ruby 和 jekyll 环境](#1-install-ruby-and-jekyll-environment)
    * [2. 复制主题代码](#2-copy-theme-code)
    * [3. 修改参数](#3-change-parameter)
        * [基本参数](#basic-info)
        * [链接参数](#link-info)
        * [评论参数](#comments-info)
        * [统计参数](#statistical-analysis-info)
    * [4. 撰写博文](#4-write-post)
    * [5. 本地启动](#5-local-launch)
    * [6. Push 到 GitHub](#6-push-to-github)
* [捐赠](#donate)
* [更新日志](#update-log)
* [版权协议](#license)
...
首页默认会显示 5 篇博文。阅读者可以点击文章标题或“阅读更多”来查看文章的详细信息。首页的侧边栏（右边）有“近期文章”、“文章分类”和“文章标签”模块。你也可以通过修改`index.html`来在这添加你自己的模块。
...
用户可以通过使用`markdown`语法来收集他们喜欢的文章链接。
