# About this Cool Concise Jekyll Blog Theme đ¤đ¤đ¤
...
**[ä¸­ćç Chinese README čŻˇçšĺťčżé đ¨đł](https://github.com/Gaohaoyang/gaohaoyang.github.io/blob/master/README-zh-cn.md)**
...
This theme supports both [disqus](https://disqus.com/) and [ĺ¤čŻ´čŻčŽş duoshuo comments](http://duoshuo.com/). It's very easy to config your comments module.
...
This theme supports Google Analytics and Baidu Statisticsďź you can just config the id in the file `_config.yml`, as follows.

```yml
# statistic analysis çťčŽĄäťŁç 
# çžĺşŚçťčŽĄ idďźĺ°çťčŽĄäťŁç ćżć˘ä¸şčŞĺˇąççžĺşŚçťčŽĄidďźĺł
# hm.src = "//hm.baidu.com/hm.js?xxxxxxxxxxxx";
# xxxxxĺ­çŹŚä¸˛
baidu_tongji_id: xxxxxxxxxxxx
google_analytics_id: UA-xxxxxxxx # google ĺćčż˝č¸Şid
```
...
description_footer: ćŹçŤčŽ°ĺ˝ćĺçŤŻäšćçć˛żééŁćŻďź
```
...
Get Google Analytics id or Baidu Statistics idďź
...
google_analytics_id: UA-7xxxxxx-4 # google ĺćčż˝č¸Şid
```
...
You can write posts at folder `_posts`. At the beginning of the post, you should declare layoutătitleădateăcategoriesătagsăauthor(optional) infoămathjax(optionalďźclick [here](https://www.mathjax.org/) for more detail about `Mathjax`).

```
---
layout: post
title:  "ĺŻščżä¸Ş jekyll ĺĺŽ˘ä¸ťé˘çćšçĺéć"
date:   2016-03-12 11:40:18 +0800
categories: jekyll
tags: jekyll çŤŻĺŁ markdown Foxit RubyGems HTML CSS
author: Haoyang Gao
mathjax: true
---
```
...
* 2017.05.25 received Wechat user ÂĽ1.00
* 2017.05.19 received éŁäšç­ ÂĽ6.66
* 2017.05.16 received ĺź éŠ° ÂĽ6.00
* 2017.05.03 received ĺ¸ć ÂĽ6.66
* 2017.04.24 received deezer ÂĽ10.00
* 2017.04.13 received Abraham Xiao ÂĽ30.00
* 2017.04.11 received Wechat user ÂĽ4.00
* 2017.04.01 received Elvin Zeng ÂĽ6.66
* 2017.03.13 received Wechat user ÂĽ6.66
* 2017.03.04 received ĺ˛čąĺ§ ÂĽ9.90
* 2017.03.02 received ć˘Śćłĺ°ç ÂĽ6.66
* 2017.02.27 received ĺ¤ĺć° ÂĽ6.66
* 2017.02.26 received ĺ°çźĺ°ĺŚ ÂĽ10.00
* 2017.02.25 received Wechat user ÂĽ6.66
* 2017.02.22 received Wechat user ÂĽ6.66
* 2017.02.15 received Wechat user ÂĽ10.00
* 2017.02.06 received Light ÂĽ10.24
* 2017.01.15 received Wechat user ÂĽ6.66
* 2016.12.17 received HitNoah ÂĽ12.00
* 2016.12.09 received ćč ÂĽ6.60
* 2016.11.25 received Wechat user ÂĽ6.66
* 2016.11.16 received Wechat user ÂĽ1.00
* 2016.10.24 received ĺĽĺł° ÂĽ6.66
* 2016.10.21 received ć­ĺťˇ ÂĽ10.00
* 2016.09.25 received éŤ ÂĽ6.66
* 2016.08.25 received Erlend Aakre $2.50
* 2016.08.10 received Wechat user ÂĽ4.40
* 2016.07.25 received éçłĺ ÂĽ6.66
* 2016.07.11 received ĺ˝ŚéŁ ÂĽ6.66
* 2016.07.07 received Klci ÂĽ2.50
* 2016.05.08 received 1057 ÂĽ10.57
* 2016.05.07 received ĺ´ć ÂĽ2
* 2016.04.29 received ĺĺ˝ ÂĽ10
* 2016.04.28 received é­ćĽéł_Brian ÂĽ2
* 2016.04.28 received čĺ˝Ź ÂĽ8.8
...
* `[+]` Add `favicon.ico`
* `[^]` Fix bug at contents
* `[^]` Change the content scroll bar CSS styleďźOnly for `webkit` browser kernelďź
