...
|LTP|哈工大|分词/词性/句法分析|-|中文|pyltp|
|THULAC|清华|分词/词性/句法分析|-|中文|中文词法分析工具包，准确率高，速度快|
|stanfordNLP|斯坦福|分词/词性/句法分析/实体识别/语法树|词干还原/wordnet(同义词)/语料库|英文|Java+python，依赖pytorch|
