...
正向/反向代理取决于代理的是**出站**请求，还是**入站**请求。
- `正向代理`： 代理的出站请求， 客户端能感知到代理程序，架构上距离客户端更近。
  - 例子：vpn/梯子
  - ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/78bfa6c4129d4c51aecdc9735d09d4dd~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
- `反向代理`： 代理的是入站请求，客户端认为代理程序就是服务器，客户端感知不到代理逻辑，架构上距离服务端更近。
  - ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5dce30e205e3496b86a50feed15de8cc~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
- ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ca2c8944b8d1443299f54d8728d97e0f~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
