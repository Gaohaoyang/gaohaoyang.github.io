...
| 画图工具OmniGraffle+Pro | [下载地址](http://www.onlinedown.net/soft/87746.htm),[注册码](http://blog.csdn.net/x_focus/article/details/41349623);[7下载地址（含许可证）](http://bbs.feng.com/forum.php?mod=viewthread&tid=10739827)  | 兼容viso，功能强大（【2017-12-6】注：7.4版才能用许可证，7.5以上不行） |
...
- 【2021-6-17】[mysql官方下载](https://dev.mysql.com/downloads/mysql/)，适配各种操作系统，含UI界面工具workbench
  - [mac下安装MySQL指南](https://www.jianshu.com/p/83c0afe1bd16)，[linux下安装指南](https://www.cnblogs.com/shenjianping/p/10984540.html)
...
- 【2018-9-19】ML 标注平台[Prodigy](https://prodi.gy/),[示例](https://prodi.gy/demo?view_id=ner)，支持模型加载+主动学习，【2019-08-16】[标注精灵](http://www.jinglingbiaozhu.com/),[Python写的标注客户端](https://github.com/monkeyDemon/AI-Toolbox/tree/master/preprocess%20ToolBox/data_annotation_tool),[ImageNet的GUI标注工具](https://github.com/tzutalin/ImageNet_Utils)，[深度学习标注工具汇总](https://blog.csdn.net/chaipp0607/article/details/79036312)，【2020-3-11】通用数据(标注)工具：用简单的网络界面/桌面应用协作标注图像、文本、文档等数据[Universal Data Tool](https://github.com/UniversalDataTool/universal-data-tool)is a web/desktop app for editing and annotating images, text, audio, documents and to view and edit any data defined in the extensible the .udt.json and .udt.csv standard.
   - ![](https://user-images.githubusercontent.com/1910070/75850482-6a2cb500-5db5-11ea-852c-7256463cece8.png)
   - 【2020-12-04】[MarkTool](https://github.com/FXLP/MarkTool) - 基于web的通用文本标注工具，支持大规模实体标注、关系标注、事件标注、文本分类、基于字典匹配和正则匹配的自动标注以及用于实现归一化的标准名标注，同时也支持文本的迭代标注和实体的嵌套标注 by Lin Yupian GitHub
   - ![](https://github.com/FXLP/Images-of-FXLP/raw/main/P1%20of%20Marktool.png)
...
- ClickHouse 是一款高性能列式分布式数据库管理系统，我们对 ClickHouse 进行了测试，发现有下列优势：
   ...
   - 其他优点见原文
- 【2021-1-1】[冰点下载](http://www.bingdian001.com/?p=30)：随意下载百度文库资料
