...
|mac下excel打开csv中文乱码|原因是mac底下中文一律utf8编码，而excel文档默认中文是gbk编码，需要单独设置下才行。[地址](http://blog.csdn.net/wqdwin/article/details/76058154)|亲测有效|
...
![jiumo](https://www.jiumodiary.com/images/front/eleps.png)，【2021-10-14】电子书搜索引擎[x5v](http://x5v.net/), 直接显示电子书及下载地址，方便快捷
...
- 翻墙：clash（mac版是clashx）、v2rayN
  ...
  - Clash的[win版](https://github.com/Fndroid/clash_for_windows_pkg/releases)、[mac版](https://github.com/Fndroid/clash_for_windows_pkg/releases) (亲测无法安装)、[apk版](https://github.com/Kr328/ClashForAndroid/releases)
