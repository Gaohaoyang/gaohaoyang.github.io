...
- 【2019-12-5】[联合国平行语料库](https://conferences.unite.un.org/UNCorpus/zh),含中英俄法西阿6中语言的平行语料；[OPUS - an open source parallel corpus](http://opus.nlpl.eu/)：众多特定领域的开源平行语料库，比如书籍、新闻、字幕、TED演讲、维基、技术手册等
