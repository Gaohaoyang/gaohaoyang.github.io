...
- 折损累计增益（DCG）
  - DCG， Discounted 的CG，就是在每一个CG的结果上处以一个折损值，为什么要这么做呢？目的就是为了让排名越靠前的结果越能影响最后的结果。假设排序越往后，价值越低。
- 归一化折损累计增益（NDCG）
...
- [公式](https://upload-images.jianshu.io/upload_images/749674-46e2d3cdfca74bfd.png?imageMogr2/auto-orient/strip|imageView2/2/w/469/format/webp)
