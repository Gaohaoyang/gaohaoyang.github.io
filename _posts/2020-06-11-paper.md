...
- 培训机器人的技术点
  ...
  2. Data2text：题目自动生成，业务方只需要准备关键词
  3. 问答模型：IR-QA/KB-QA/MRC-QA
  4. 小贝客户模拟器
  5. 小贝主动发问策略：RL里的DQN/BBQ等
  6. 基于画像的文本风格话
  7. 元学习在培训中应用：小样本学习，业务方不太可能按照监督学习模式提供大规模标注语料，他们能准备的只有100-200的少样本，因此需要探索小样本学习、语义匹配模式实现NLU功能
  8. 多模态会话评价：除了文本，还要结合行为（页面点击）、情绪、声音特征
  9. 因果推理
...
- [Paperwithcode](https://paperswithcode.com)，[Browse State-of-the-Art](https://paperswithcode.com/sota)
- 【2020-7-5】快速找到最新AI技术的模型/代码/API】“[CatalyzeX: machine intelligence to catalyze your projects](https://www.catalyzex.com/)”
- 对话系统领域[sota论文](http://nlpprogress.com/english/dialogue.html)
