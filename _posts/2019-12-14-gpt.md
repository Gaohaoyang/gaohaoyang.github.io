...
- ![img](http://p9.itc.cn/q_70/images03/20201111/dfb14796eddd4a4eac1f436e8d0041ec.png)
- ![img](http://p8.itc.cn/q_70/images03/20201111/6bfcefd3a0d14eb1be6fac226a89c756.png)
...
如果把生成的句子看作 A，已知的语言模式看作 B，那么 ChatGPT 可以通过`贝叶斯定理`计算出 $ P(A|B) $，从而确定生成的句子是否合理。同样，在对话系统中，如果把回答看作 A，已知的问题和信息看作 B，那么 ChatGPT 可以通过贝叶斯定理计算出 $ P(A|B) $，从而确定回答的概率。
