...
注意：
- gpt3模型付费API试用版，注册一个账号送18美金，每750字消耗2美分
...
现有大多数 ChatGPT API 实际上是 OpenAI `GPT3` 模型接口，模型名称为“`text-davinci-003`”，调用费用为 0.02美元/1000tokens，折合下来差不多0.1元400~500字。这个字数包括问题和返回结果字数。
