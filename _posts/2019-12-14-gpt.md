...
ChatGPT 体验方式
- （1）直接OpenAI官网体验ChatGPT —— <span style='color:red'>体验效果较好，但需要梯子访问</span>
...
- （2）第三方软件转OpenAI官网 —— 体验效果较好，但需要梯子访问
  ...
  - 网页版：网页版ChatGPT基于GPT-3.5
    - 限制：从 ChatGPT页面 获取session_token，使用 revChatGPT 直接访问web接口，但随着ChatGPT接入Cloudflare人机验证，这一方案难以在服务器顺利运行。
