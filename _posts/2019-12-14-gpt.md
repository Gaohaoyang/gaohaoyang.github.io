...
<div class="mermaid">
    ...
    classDef grass fill:#C8D64B;
    %%节点关系定义
    S(多模态大模型)-->|2022-4-29,DeepMind|F(Flamingo):::orange
    F-->|2023-3-29,Christoph Schuhmann\n开源复制品,LMM框架,LLaMA| O(OpenFlamingo)
    A-->|transformer|B(GPT-1):::grass
    B-->|2019-2,OpenAI,无监督多任务,去掉fine-tune|C(GPT-2):::grass
    C-->|2020-1-17,图像领域|H(Image GPT)
    B-.->|2020, Andrej Karpathy,民用|B1(minGPT)
...
【2023-4-19】[Visual Instruction Tuning: 用LLaVA近似多模态GPT-4](https://mp.weixin.qq.com/s/Ygf2j-rsyLTwZx3FDK6KEQ) 用 GPT-4 进行视觉指令学习
