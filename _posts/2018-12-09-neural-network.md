...
- [神经网络的结构](#神经网络的结构)
  ...
  - [神经网络的运作机制](#神经网络的运作机制)
  - [**为什么神经网络的分层结构能起作用？**](#为什么神经网络的分层结构能起作用)
  - [**深度学习的本质：通过组合简单的概念来表达复杂的事物**](#深度学习的本质通过组合简单的概念来表达复杂的事物)
  - [**隐藏单元是如何被激活的？**](#隐藏单元是如何被激活的)
    - [权重和偏置](#权重和偏置)
  - [**权重与偏置的实际意义**](#权重与偏置的实际意义)
  - [**矢量化编程**](#矢量化编程)
  - [**机器“学习”的实质**](#机器学习的实质)
  - [非线性激活函数](#非线性激活函数)
  - [**为什么要使用非线性激活函数？——神经网络的万能近似定理**](#为什么要使用非线性激活函数神经网络的万能近似定理)
  - [**新时代的激活函数——线性整流单元 ReLU**](#新时代的激活函数线性整流单元-relu)
- [梯度下降法](#梯度下降法)
  - [**神经网络是怎样学习的？**](#神经网络是怎样学习的)
...
- [反向传播算法（Backpropagation Algorithm, BP）](#反向传播算法backpropagation-algorithm-bp)
  - [反向传播的直观理解](#反向传播的直观理解)
  - [**示例：单个训练样本对参数调整的影响**](#示例单个训练样本对参数调整的影响)
    - [BP 算法小结](#bp-算法小结)
    - [相关代码](#相关代码)
