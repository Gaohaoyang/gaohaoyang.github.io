...
- <img src="https://pic4.zhimg.com/80/v2-b36ef92aabab27e6ce53e2d0c66e770f_720w.jpg" width="70%" >
...
- <img src="https://pic4.zhimg.com/80/v2-4ba1b7d04c066452bfe03492a0e4803f_720w.jpg" width="70%" >
...
- 策略表：E表示擦除、P表示打印、L表示左移。
  - <img src="https://pic1.zhimg.com/80/v2-b236f764ee2b1fee60b76400d3b01a20_720w.jpg" width="70%" >
  - 该图灵机有3种工作状态：+1、左移和判断
  ...
  - ![](https://pic4.zhimg.com/80/v2-04ec7765ec434701710f52ec43b30e63_720w.jpg)
...
- <img src="https://pic1.zhimg.com/80/v2-8383f0d2038dd8e8b52eaf8f92cacc8c_720w.jpg" width="60%" >
再构建一台图灵机G，其运行流程如下图所示。如果H输出1，说明G会停机，但事实上它将陷入循环；如果H输出0，说明G不会停机，但事实上它将停机。
- <img src="https://pic4.zhimg.com/80/v2-8f244b5457adf4c0a05927f99fb1a337_720w.jpg" width="60%" >
...
<iframe src="//player.bilibili.com/player.html?aid=457294840&bvid=BV145411j7aH&cid=242822115&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%"> </iframe>
...
- <img src="https://files.mdnice.com/user/18668/b6679a93-6df2-4292-8af1-e0cc1380949a.png" width="70%" >
...
![](https://files.mdnice.com/user/18668/aea49f0b-c017-46cc-8b1e-dcc3a82680e3.png)
...
- 答：慢，缓慢的磁盘会影响我们程序执行的速度，因此需要更加快速、离CPU更近的存储，那就是内存。内存是一大块存储空间，可以存储很多数据信息
  - <img src="https://files.mdnice.com/user/18668/55aefa17-cf26-4888-a722-edd5ce01a99b.png" width="50%" >
- 问：如何找到程序？
- 答：地址，每个字节在内存中都有一个地址，这样当CPU去内存中读程序时，只需要根据对应的地址就可以知道程序的具体内容。
  - <img src="https://files.mdnice.com/user/18668/62164b31-7f34-4fd6-b888-aadf7cb87a3b.png" width="50%" >
- 问：CPU是如何与内存、磁盘通信？
...
- 答：① 任务分工，如果把所有的任务都交给CPU来处理，CPU太忙；② 备份，如果南桥芯片坏了，可以直接更换南桥，而不用换掉整个CPU。
  - <img src="https://files.mdnice.com/user/18668/05c4212f-e7c1-4b2f-9ed7-d63587ab1d68.png" width="80%" >
...
- **时钟**：它并不是我们见的钟表概念，它代表了你的CPU的工作频率，频率越高说明你的CPU处理的速度越快，但是越快就会带来另一个问题：散热。
  - <img src="https://files.mdnice.com/user/18668/de8e7830-725e-4d08-8e08-d4b0240d0f4d.png" width="80%" >
...
执行过程：
- <img src="https://files.mdnice.com/user/18668/de503c08-c5cc-4665-be0a-9c39eb0b2faa.png" width="80%" >
...
- 指令寄存器发现此处是比较逻辑，会执行a-b，此时可能会有三个结果分别是大于0，等于0，小于0，然后把这个结果存到标志寄存器里
  ...
  - <img src="https://files.mdnice.com/user/18668/42675cb6-c8aa-4d4b-b4dc-4b285c74e988.png" width="80%" >
