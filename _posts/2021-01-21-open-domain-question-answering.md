...
1. Word embeddings: A 300d [Glove]({{ site.baseurl }}{% post_url 2017-10-15-learning-word-embedding %}#glove-global-vectors) word embedding trained from 800B Web crawl data, $$f_\text{embed} = E_g(z_i)$$.
